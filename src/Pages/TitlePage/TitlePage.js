...
export default function TitlePage() {
  ...
  // creates boolean value if all are true
  const birthdayMessage = month === 6 && day === 2 && email === "rachelfinegan@gmail.com" && time >= 10
    ...
    <div className="title-page-container container">
      {birthdayMessage && (
        <a href="https://m.media-amazon.com/images/I/71lKlhpUAPL._AC_SX425_.jpg" className="birthdayMessage">
          <div className="">
            Happy Birthday! <div>You're {yearsOld} years young and look better than ever!</div>
          </div>
        </a>
      )}
      {dataExists ? (
